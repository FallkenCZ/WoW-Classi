...
local defaultpack = {
    ...
    ["peepoValiW"] = "Interface\\AddOns\\TwitchEmotes\\TwitchPresents\\ZXValicera\\peepoValicera.tga:LARGE",
    ...
    ["gachiSLAPW"] = "Interface\\AddOns\\TwitchEmotes\\TwitchPresents\\ZXValicera\\gachiSLAP.tga:LARGE",
...
local dropdown_options = {
    ...
    [02] = {
        ...
        "xqcEZ","xqcF","xqcFast","xqcGun","xqcH","xqcHands","xqcHug",
        "xqcHugged","xqcJuice","xqcKek","xqcL","xqcLeather","xqcLie",
        "xqcLook","xqcM","xqcMood","xqcOld","xqcPoppin","xqcQ","xqcRage",
        "xqcS","xqcSad","xqcSleeper","xqcSmile","xqcSmile2","xqcSmug",
        "xqcSword","xqcT","xqcThonk","xqcTOS","xqcTree","xqcWar","xqcWut","xqcY"
},
    [03] = {
        "BTTV+FFZ 1", "4Head", "ANELE", "AngelThump", "BibleThump",
        "bUrself", "BBona", "BabyRage", "BlessRNG", "BloodTrail", "ConcernDoge",
    ...
    [04] = {
        ...
        "WutFace", "WutFaceW", "ZULUL", "ZULOL"
    },
    [05] = {
        "Custom 1", "NeckBeard", "Krug", "Depresstiny",
        "DestiSenpaii", "Disgustiny", "GODSTINY", "HmmStiny", "Klappa",
        "LeRuse", "jerryWhat", ":blinking:", "NOBULLY", "NoTears", "OverRustle",
        "PEPE", "REE", "SURPRISE", "SWEATSTINY", "YEE", "VoHiYo", "AYAYA",
        "bjornoVV", "bjornoVVona", "chupBro", "chupDerp", "chupHappy",
        "StareBruh", "Clap", "cptfriHE", "Del", "ednasly", "endANELE",
        "endBomb", "AMAZIN", "pokiW", "ThisIsFine"
    },
    [06] = {
        "Custom 2", "ANEBruh", "endDawg", "endFrench", "endHarambe", "endKyori",
        "endNotLikeThis", "HappyMerchant", "HyperAngryMerchant", "endRP",
        "endTrump", "FlipThis", "fruitBug", "HYPEROMEGALUL",
        ":praise:", "marcithMath", "monkeyS", "oldmorDim", "PogCena",
        "OkayChomp", "mastahFloor", "selyihHEY", "SuicideThinking", "BOGGED",
        "Stonks", "DogeKEK", "sosig","sosigW","LOLW", "OMEGALOL", "ZOINKS"
    },
    [07] = {
        "Custom 3", "FLOPPERS", "cmoN", "OhISee", "Poghurt", "KEKW",
        "KEKWeird", "KEKSad", "KEKL", "BroKiss", "pOg", "Pogey", "PogeyU",
        "KKonaW", "kkOna", "Pogomega", "cmonEyes", "TriKool", "5Hard", "TriPeek",
        "TriEasy", "TriGold", "TriHardo", "0Head", "1Head", "2Head", "3Head",
        "3Lass", "4HEader", "4Weird", "4Shrug", "4Mansion", "5Head"
    },
    [08] = {
        "Custom 4", "PogWarts", "noxSorry", "AMAZINGA", "BaconEffect",
        ":fluff:", "PATHETIC", "TriHardS", "HYPERDANSGAMEW", "MaN", "NaM",
        "VaN", "WhiteKnight", "BlackKnight", "PikaWOW", "Boomer", "Zoomer",
        "Coomer", "WeirdChamp", "WutChamp", "StareChamp", "OkayChamp",
        "MaldChamp", "starechamp", "SadChamp", "OkayChomp", "SillyChamp",
        "LULChamp", "CrazyChamp", "WeirdBruh"
    },
    [09] = {
    ...
    [10] = {
        ...
        "nymnM", "nymnNA", "nymnNo", "nymnNormie", "nymnPains", "nymnR"
    },
    [11] = {
    ...
    [12] = {
        "Drainerx","drxBrain","drxCS","drxD","drxWeird","drxSSJ","drxPog","drxDict",
        "drxEyes","drxFE","drxED","drxFE1","drxED2","drxFEED","drxCri",
        "drxGlad","drxGod","drxmonkaEYES","drxR","drxW","drxLit","drxLUL",
        "drxCozy","drxHappy","drxHey","drxMad","drxSad","drxSmart","drxSmile",
        "drxSpace","drxWink"
    },
    [13] = {
        "Emojis", ":poop:", ":blush:", ":flush:", ":door:", ":zap:", ":gun:",
        ":hand:", ":pray:", ":joy:", ":yum:", ":rolling_eyes:", ":smiley:",
        ":wink:", ":smirk:", ":tired:", ":weary:", ":thinking:",
        ":muscle:", ":ok_hand:", ":point_right:", ":point_left:",
        ":writing_hand:", ":book:", ":clock:", ":bear:", ":crab:", ":shrimp:", ":lizard:", ":rage:",
        ":wheelchair:", ":eye:", ":eyes:", ":eggplant:", ":sweat_drops:",
        ":peach:", ":tongue:", ":heart:", ":kiss:", ":100:", ":oof:", ":mega:",
        ":bell:", ":crown:", ":question:"
    },
    [14] = {
    ...
    [16] = {
        ...
        "forsenWut", "forsenX", "forsenY", "forsenYHD"
    },
    [17] = {
        ...
        "rooVV", "rooWhine", "rooWut", "rooUwU","rooGun","rooScream","rooDuck",
    ...
    [19] = {
        ...
        "radiantWave", "radiantWeird", "02Yum", "02Dab", "02Stare", ":HEH:"
    },
    [20] = {
    ...
    [22] = {
        ...
        "POOGERS", "POGGIES", "PepegaSad", "PepegaHands", "PepeFU", "Okayge",
        "Sadge", "PepeFrench", "PepeJew", "PepeScoots", "GiggleHands",
        "PepeHammer", "PepeWizard", "PepeBruh", "PepeGang", "FeelsRottenMan",
        ":need:", ":memes:", ":drama:"
    },
    [23] = {
        "Pepe 4", "PepePoo", "SadPepe", "PepeXD", "PepeMods", "monakHmm",
    ...
    [24] = {
        ...
        "peepoSmile","peepoPoo", "peepoTired", "peepoSad",
        "peepoS", "peepoHug", "peepoHugged", "peepoAP", "peepoEZ", "peepoCool",
        "peepoBeer", "peepoFat","peepoChonk","peepoHit", "peepoFight", "peepoPat",
        "peepoSick", "peepoBlush", "peepoThink", "peepoPlot", "peepoWTF",
        "peepoHide", "peepoYes", "peepoNo", "peepoMaybe"
    },
    [25] = {
        ...
        "pillowJammies", "peepoFriends","peepoSadJAM","peepoCat","peepoSleepo"
    },
    [26] = {
        "Suze4Mumes Life P1", "beamBrah", "beamB", "CaptainSuze", "peep420",
        "JanCarlo2", "mumes", "peepoKnifeNANI", "peepoStab", "peepoH",
        "PepeClown", "SadHonk", "ClownPain", "ClownBall", "SchubertSmile",
        "PepeKing", "peepoKing", "peepoCrown", "peepoWeirdCrown", "PepeScience",
        "peepoCozy", "suzeOK", "ANELELUL", "bubby", "FeelsCozyMan", "miffs",
        "peepoCheer", "peepoCry", "peepoDK", "peepoMad", "PepeBed", "PepeChill",
        "PepeCool", "EZGiggle"
    },
    [27] = {
        "Suze4Mumes Life P2", "PepeLaffe", "coffeeS", "peepoEZSip",
        "PepeGiggle", "PepeKingLove", "PepeSpartan", "PepeSuspect", "peepoChef",
...
function MyMod_MinimapButton_OnClick()
    Lib_ToggleDropDownMenu(1, nil, EmoticonChatFrameDropDown,
